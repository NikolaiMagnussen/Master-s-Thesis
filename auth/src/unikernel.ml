...
module Auth (CON : Conduit_mirage.S) = struct
  ...
  let token_map =
    ...
    Hashtbl.add tbl "4a183696-c4cc-48fe-90b9-831147ec12a2" "user-capabilities";
    Hashtbl.add tbl "fefb7751-7893-435e-82fd-25f0becb3c64" "admin-capabilities";
    tbl
  ...
  let check_token token =
    ...
    | Some cap -> let body = "You have: " ^ cap in
